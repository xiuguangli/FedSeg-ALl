...
##############################
    ...
    parser.add_argument('--torch_disable_tf32', type=str2bool, default=False,
                        help='disable TensorFloat-32 for torch matmul/cudnn conv when debugging parity')
    parser.add_argument('--torch_strict_deterministic', type=str2bool, default=False,
                        help='enable stricter torch deterministic algorithms for debugging parity')
    ...
    parser.add_argument('--debug_freeze_bn_stats', type=str2bool, default=False,
                        help='freeze BatchNorm running statistics during local training for debugging')
